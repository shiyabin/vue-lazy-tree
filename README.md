...
```html
<vue-lazy-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></vue-lazy-tree>
  ...
  export default {
    ...
    methods: {
      ...
      loadNode(node, resolve) {
        ...
        /**
         * 在resolve中第二个参数为总条数,如果需要分页可以传递总条数
         * node之中保存了currentPage:currentPage根据调用次数递增
        */
